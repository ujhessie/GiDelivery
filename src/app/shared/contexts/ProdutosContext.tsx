  ...
  export const ProdutosContext: Context<IprodutosSimulados[]> = createContext<IprodutosSimulados[]>([]);

  // Provedor de produtos
  export const ProdutosProvider: React.FC<IProdutosProviderProps> = ({ children }) => {
